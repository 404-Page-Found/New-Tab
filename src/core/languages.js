...
const translations = {
  en: {
    ...
    dateLong: "Long (e.g., Saturday, April 25)",
    dateShort: "Short (e.g., 4/25/2026)",
    dateCompact: "Compact (e.g., Apr 25)",
  ...
  zh: {
    ...
    dateFormat: "日期格式",
    dateLong: "完整 (例如：星期六，四月 25)",
    dateShort: "短 (例如：4/25/2026)",
    dateCompact: "简洁 (例如：四月 25)",
